...
/*
EngineApiService Get engine info
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return EngineInfoResponse
*/
func (a *EngineApiService) GetEngineInfo(ctx context.Context) (EngineInfoResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EngineInfoResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/management/engine"
...
/*
EngineApiService List engine properties
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return map[string]string
*/
func (a *EngineApiService) GetProperties(ctx context.Context) (map[string]string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/management/properties"
