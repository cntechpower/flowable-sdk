...
type BpmnDiEdge struct {
	SourceDockerInfo *GraphicInfo `json:"sourceDockerInfo,omitempty"`
	TargetDockerInfo *GraphicInfo `json:"targetDockerInfo,omitempty"`
	Waypoints []GraphicInfo `json:"waypoints,omitempty"`
}
