...
type HistoryJobResponse struct {
	Id string `json:"id,omitempty"`
	Url string `json:"url,omitempty"`
	ScopeType string `json:"scopeType,omitempty"`
	Retries int32 `json:"retries,omitempty"`
	ExceptionMessage string `json:"exceptionMessage,omitempty"`
	JobHandlerType string `json:"jobHandlerType,omitempty"`
	JobHandlerConfiguration string `json:"jobHandlerConfiguration,omitempty"`
	AdvancedJobHandlerConfiguration string `json:"advancedJobHandlerConfiguration,omitempty"`
